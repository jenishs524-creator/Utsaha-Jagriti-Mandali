...
const Branches: React.FC<BranchesProps> = ({ isMain = false }) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!isMain && (
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-church-900 mb-4">Our Locations</h2>
              ...
              <div className="p-10 flex flex-col flex-grow">
                ...
                <div className="space-y-4 mb-8 flex-grow">
                  <div className="flex items-start space-x-3 text-slate-500">
                    ...
                    <p className="text-sm font-medium leading-relaxed">{branch.location}</p>
                  </div>
                  {/* Show established date and elder only for the main church card */}
                  {branch.id === 'main' && (
                    <>
                      <div className="flex items-center space-x-3 text-slate-400">
                        <Calendar className="w-4 h-4" />
                        <span className="text-xs">Est.: {branch.established}</span>
                      </div>
                      <div className="flex items-center space-x-3 text-slate-400">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-slate-50">
                   <span className="text-nepal-blue font-black text-xs uppercase tracking-widest">Learn More</span>
