...
const BranchDetail: React.FC<BranchDetailProps> = ({ branchId }) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
              <div className="space-y-8">
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest">Established</h4>
                ...
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest">Branch Leader</h4>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-5">
                  ...
                  <div>
                    <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest">Service Starts</h4>
